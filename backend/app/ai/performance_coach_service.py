...
class PerformanceCoachService(BaseAIAgent):
    ...
    async def review_trade(
        ...
        try:
            ...
            # Build prompt
            instruction = "Provide structured review and improvement insights for this trade"
            prompt = self._build_standard_prompt_template(
                trade_data.get('symbol', 'Unknown'), data_sections, instruction, json_schema
            )
    ...
    async def analyze_performance_patterns(
        ...
        try:
            ...
            analysis_data = {
                ...
                "Recent Trades Sample": json.dumps(trade_history[-10:], indent=2, default=str)
            }
            ...
            return {
                ...
                "strategic_recommendations": pattern_data.get("strategic_recommendations", []),
                "risk_management_insights": pattern_data.get("risk_management_insights", []),
    ...
    async def process(self, trade_data: Dict[str, Any], market_context: Dict[str, Any],
                     system_performance: Dict[str, Any], **kwargs) -> TradeReview:
