...
async def handle_pull_request_event(payload: WebhookPayload, github_service: GitHubAutomationService):
...
async def handle_push_event(payload: WebhookPayload, github_service: GitHubAutomationService):
...
async def handle_issue_event(payload: WebhookPayload, github_service: GitHubAutomationService):
...
async def handle_release_event(payload: WebhookPayload, github_service: GitHubAutomationService):
