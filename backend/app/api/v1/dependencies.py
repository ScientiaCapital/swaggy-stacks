...
class RateLimiter:
    ...
    async def check_rate_limit(self, request: Request) -> bool:
        ...
        self.requests = {
            ...
            if any(current_time.timestamp() - t.timestamp() <= self.period for t in times)
        }
...
async def check_system_health() -> Dict[str, Any]:
    ...
    try:
        ...
        health_status["components"]["trading_manager"] = tm_health.get("trading_manager", "unknown")
...
def create_error_response(error: str, message: str, details: Dict = None) -> Dict[str, Any]:
...
__all__ = [
    ...
    # Trading system
    'get_initialized_trading_manager', 'get_strategy_agent', 'get_markov_system',
