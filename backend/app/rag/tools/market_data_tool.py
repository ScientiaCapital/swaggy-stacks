            ...
            return json.dumps(
                {
                    ...
                    "price_vs_vwap": (
                        round((current_price / vwap - 1) * 100, 2) if vwap > 0 else 0
                    ),
                    "volume_stats": {
                    ...
                    "volume_trend": (
                        "increasing" if volumes[-1] > avg_volume else "decreasing"
                    ),
                    "timestamp": datetime.now().isoformat(),
                }
            )
            ...
            return json.dumps(
                {
                    ...
                    "gap_from_close": (
                        round(premarket_price - regular_price, 2)
                        if premarket_price > 0 and regular_price > 0
                        else 0
                    ),
