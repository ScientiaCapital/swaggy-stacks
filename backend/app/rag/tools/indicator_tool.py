...
class IndicatorTool:
    ...
    def _calculate_macd(self, params: str) -> str:
        ...
        try:
            ...
            prev_histogram = float(histogram.iloc[-2]) if len(histogram) > 1 else current_histogram
        ...
        try:
            ...
            return json.dumps({
                ...
                "analysis": {
                    ...
                    "squeeze": band_width < (current_sma * 0.1)  # Bollinger squeeze
                }
            })
        ...
        try:
            ...
            return json.dumps({
                ...
                "analysis": {
                    ...
                    "distance_to_closest": round(abs(closest_level[1] - current_price), 2),
                    "trend_direction": "retracement" if swing_low < current_price < swing_high else "extension"
                }
            })
    ...
    def _calculate_moving_averages(self, params: str) -> str:
        ...
        try:
            parts = params.split(',')
            symbol = parts[0].strip().upper()
            periods = [int(p.strip()) for p in parts[1:]] if len(parts) > 1 else [20, 50, 200]
            ...
            return json.dumps({
                ...
                "golden_cross": (
                    mas.get("MA50") and mas.get("MA200") and 
                    mas["MA50"] > mas["MA200"] and current_price > mas["MA50"]
                ),
                "death_cross": (
                    mas.get("MA50") and mas.get("MA200") and 
                    mas["MA50"] < mas["MA200"] and current_price < mas["MA50"]
