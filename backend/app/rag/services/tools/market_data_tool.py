...
class MarketDataTool(AgentTool):
    ...
    async def _get_historical_data(
        self, client: AlpacaClient, parameters: Dict[str, Any], symbols: List[str]
    ) -> ToolResult:
    ...
    async def _get_quotes(self, client: AlpacaClient, symbols: List[str]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(success=True, data=quotes, metadata=metadata)
    ...
    async def _get_trades(self, client: AlpacaClient, symbols: List[str]) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(success=True, data=trades, metadata=metadata)
