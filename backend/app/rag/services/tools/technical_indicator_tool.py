...
class TechnicalIndicatorTool(AgentTool):
    ...
    def _generate_cache_key(
        self, indicator: str, data: List[Dict], parameters: Dict[str, Any]
    ) -> str:
        ...
        try:
            ...
            result_data = {
                ...
                "signal": self._interpret_rsi(
                    float(rsi.iloc[-1]) if not rsi.empty else None
                ),
            }
    ...
    async def _calculate_bollinger_bands(
        ...
        try:
            ...
            result_data = {
                ...
                "signal": self._interpret_bollinger(
                    latest_price, latest_upper, latest_lower, latest_middle
                ),
            }
    ...
    def _interpret_macd(
        self, macd: Optional[float], signal: Optional[float], histogram: Optional[float]
    ) -> str:
