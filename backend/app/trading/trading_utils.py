...
def calculate_pnl(entry_price: float, current_price: float, quantity: float) -> Dict[str, float]:
    ...
    unrealized_pnl_pct = calculate_percentage_change(
...
def calculate_risk_metrics(positions: List[Dict], account_value: float) -> Dict[str, float]:
    """
...
def calculate_position_size(account_value: float,
                           ...
                           entry_price: float,
                           stop_loss: float,
                           max_position_pct: float = 0.1) -> Dict[str, float]:
    """
...
__all__ = [
    ...
    'calculate_position_value', 'calculate_percentage_change', 'calculate_pnl',
    'calculate_risk_metrics', 'round_to_tick_size', 'calculate_stop_loss',
    'calculate_position_size', 'is_market_open', 'format_currency',
    'calculate_sharpe_ratio', 'generate_order_id', 'parse_market_data',
