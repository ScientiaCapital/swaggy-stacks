...
class PositionOptimizer:
    ...
    def calculate_volatility_adjusted_size(
        ...
        try:
            ...
            portfolio_vol_adjustment = min(1.0, portfolio_volatility / max(symbol_volatility, 0.01))
    ...
    def calculate_optimal_position_size(
        ...
        try:
            ...
            logger.error("Error calculating optimal position size", error=str(e), symbol=symbol)
    ...
    def get_historical_performance(self, symbol: Optional[str] = None) -> Dict:
        ...
        try:
            ...
            avg_loss = abs(np.mean([t['pnl_percent'] for t in losses])) if losses else 0.0
    ...
    def _calculate_correlation_adjustment(
        ...
        try:
            ...
            if new_symbol in tech_stocks:
                ...
                finance_count = len([s for s in existing_symbols if s in finance_stocks])
    ...
    def get_optimization_summary(self) -> Dict:
        ...
        return {
            'settings': {
                ...
                'kelly_fraction_range': [self.min_kelly_fraction, self.max_kelly_fraction],
