...
class HealthChecker:
        ...
        try:
            ...
            return HealthCheckResult(
                ...
                details={
                    ...
                    "server_configs_loaded": len(self._mcp_orchestrator._server_configs)
                }
            )
    ...
    def _compile_system_status(self, results: List[HealthCheckResult]) -> SystemHealthStatus:
    ...
    async def get_system_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_response_time_ms": sum(c.response_time_ms for c in health_status.components) / len(health_status.components) if health_status.components else 0,
